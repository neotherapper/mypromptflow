...
- Validate using focused validators: `ai-instruction-validator`, `framework-compliance-validator`
...
- Validation: `ai-instruction-validator.md`, `framework-compliance-validator.md`
- Task Coordination: `project-manager.md`
