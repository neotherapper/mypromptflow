...
description: The Qdrant Vector Database MCP server represents a cutting-edge semantic
  search and AI-powered data intelligence solution specifically designed for business
  risk management operations requiring advanced document search, similarity matching, and
