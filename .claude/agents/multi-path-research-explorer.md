...
description: "Research exploration specialist using tree of thoughts methodology for multi-path reasoning and comprehensive possibility exploration. Invoke for creative research requiring multiple exploration pathways."
...
path_selection_framework:
  ...
  exploratory_research:
    primary_criteria:
      ["innovation_potential", "breakthrough_probability", "creative_insights"]
    preferred_paths: ["innovative", "contrarian"]
    backup_paths: ["hybrid", "conservative"]

  comprehensive_research:
    primary_criteria:
      ["coverage_breadth", "multiple_perspectives", "robust_validation"]
    preferred_paths: ["hybrid", "conservative", "innovative"]
    backup_paths: ["contrarian"]

  strategic_research:
    primary_criteria:
      ["long_term_value", "strategic_alignment", "competitive_advantage"]
